...
const createPerson = (req, res) => {
    const { name } = req.body;
    if (!name) {
        return res.status(400).json({ success:false, msg: 'please provice name value' });
    }
...
module.exports = { getPeople, createPerson, createPersonPostman, modifyPerson, deletePerson }